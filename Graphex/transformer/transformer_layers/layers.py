...
class DecoderLayer(nn.Module):
    ...
    def forward(self, inputs):
        ...
        """
        x, encoder_outputs, attetion_weights, src_mask, tgt_mask = inputs
        
        # Layer Normalization before decoder self attention
        x_norm = self.layer_norm_mha_dec(x)
        
        # Masked Multi-head attention
        y, _ = self.multi_head_attention_dec(x_norm, x_norm, x_norm, tgt_mask)
        ...
        y, attetion_weights = self.multi_head_attention_enc_dec(x_norm, encoder_outputs, encoder_outputs, src_mask)
        ...
        return y, encoder_outputs, attetion_weights, src_mask, tgt_mask
