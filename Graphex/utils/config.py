...
parser.add_argument("--latent_dim", type=int, default=68)
parser.add_argument("--emb_dim", type=int, default=100)
parser.add_argument("--batch_size", type=int, default=8)
parser.add_argument("--lr", type=float, default=0.0001)
parser.add_argument("--max_grad_norm", type=float, default=2.0)
parser.add_argument("--max_enc_steps", type=int, default=1500)
...
#emb_file = "vectors/embeddings_simp_mask.txt"
#emb_file = "vectors/embeddings_simp.txt"
emb_file = "vectors/embeddings_new.txt"
vocab_file = "data_new/vocab.txt"
